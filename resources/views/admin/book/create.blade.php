...
@section('content')
    <div class="middle"><!-- start middle -->
        ...
        <form method="post" action="{{route('book.store')}}" class="text-right mr-5 mb-3" enctype="multipart/form-data">
            {{csrf_field()}}
            @include('admin.section.errors')
            <div class="form-control border-primary">
                <div class="form-group mt-3">
                    <input type="text" class="form-control ml-2" id="title" name="title"
                           value="{{old('title')}}" placeholder="عنوان کتاب را وارد کنید">
                </div>
                <div class="form-group mt-3">
                ...
                <div class="form-group mt-3">
                    <input type="text" class="form-control ml-2" id="price" name="price"
                           value="{{old('price')}}" placeholder="قیمت کتاب را وارد کنید">
                </div>
